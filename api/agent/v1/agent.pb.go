...
const file_agent_v1_agent_proto_rawDesc = "" +
	...
	"\x14ListAvailablePlugins\x12%.agent.v1.ListAvailablePluginsRequest\x1a&.agent.v1.ListAvailablePluginsResponse\"\x00B\x8e\x01\n" +
	"\fcom.agent.v1B\n" +
	"AgentProtoP\x01Z1github.com/observabil/arcade/api/agent/v1;agentv1\xa2\x02\x03AXX\xaa\x02\bAgent.V1\xca\x02\bAgent\\V1\xe2\x02\x14Agent\\V1\\GPBMetadata\xea\x02\tAgent::V1b\x06proto3"
