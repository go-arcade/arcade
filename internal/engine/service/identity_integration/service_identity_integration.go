...
import (
	...
	identityrepo "github.com/go-arcade/arcade/internal/engine/repo/identity_integration"
...
type IdentityIntegrationService struct {
	identityRepo identityrepo.IIdentityIntegrationRepository
	userRepo     userrepo.IUserRepository
}

func NewIdentityIntegrationService(identityRepo identityrepo.IIdentityIntegrationRepository, userRepo userrepo.IUserRepository) *IdentityIntegrationService {
...
func (iis *IdentityIntegrationService) Callback(providerName, state, code string) (*user.Register, error) {
...
// LDAPLogin LDAP 登录
func (iis *IdentityIntegrationService) LDAPLogin(providerName, username, password string) (*user.Register, error) {
	integration, err := iis.identityRepo.GetProvider(providerName)
	if err != nil {
...
func (iis *IdentityIntegrationService) registerOrLoginUser(providerName string, userInfo *sso.UserInfoAdapter) (*user.Register, error) {
	// split name into first and last name
	firstName, lastName := splitName(userInfo.Name, userInfo.Nickname)

	registerUserInfo := &user.Register{
