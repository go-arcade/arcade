...
import (
	...
	secretrepo "github.com/go-arcade/arcade/internal/engine/repo/secret"
...
func (ss *SecretService) CreateSecret(secretEntity *secret.Secret, createdBy string) error {
	...
	log.Infof("secret created successfully: %s", secretEntity.SecretId)
	return nil
}

// UpdateSecret updates a secret
func (ss *SecretService) UpdateSecret(secretId string, secretEntity *secret.Secret) error {
...
func (ss *SecretService) GetSecretList(pageNum, pageSize int, secretType, scope, scopeId, createdBy string) ([]*secret.Secret, int64, error) {
...
func (ss *SecretService) GetSecretsByScope(scope, scopeId string) ([]*secret.Secret, error) {
