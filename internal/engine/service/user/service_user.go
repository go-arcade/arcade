...
type LoginService interface {
	Login(login *user.Login, auth http.Auth) (*user.LoginResp, error)
}
...
func (ul *UserService) Login(login *user.Login, auth http.Auth) (*user.LoginResp, error) {
...
func (ul *UserService) Register(register *user.Register) error {
...
func (ul *UserService) AddUser(addUserReq user.AddUserReq) error {
...
func (ul *UserService) UpdateUser(userId string, userEntity *user.User) error {
	var err error
...
func (ul *UserService) ResetPassword(userId string, req *user.ResetPasswordReq) error {
