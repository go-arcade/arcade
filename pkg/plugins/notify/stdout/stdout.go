...
func (p *StdoutNotify) Type() (string, error) {
	return string(pluginpkg.TypeNotify), nil
}
...
func (p *StdoutNotifyPlugin) Server(*plugin.MuxBroker) (interface{}, error) {
	return &StdoutNotifyRPCServer{impl: p.Impl}, nil
}

// Client returns the RPC client (not used in plugin side)
func (StdoutNotifyPlugin) Client(b *plugin.MuxBroker, c *rpc.Client) (interface{}, error) {
	return nil, nil
}
